...
if($_POST)
{
    ...
    $query = mysqli_query($connection,"insert into tb_product(pro_name , pro_price , pro_details) values('{$pname}','{$pprice}','{$pdetails}')") or die(mysqli_error($connection));
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputEmail1" placeholder = "Enter Product Name" name="pname" required >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputEmail1" placeholder=" Enter Product Name " name="pprice" required >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea  class="form-control" required name="pdetails" ></textarea>
                                </div>
                            </div>
